...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xaa25Aa7a19f9c426E07dee59b12f944f4d9f1DD3); // testnet
    //address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address WBNB = 0xaa25Aa7a19f9c426E07dee59b12f944f4d9f1DD3; // testnet
    IDEXRouter router;
...
contract CatFruitCoin is IBEP20, Auth {
    ...
    uint256 public reflectionFee   = 0; // no reflections
    uint256 public devFee          = 5;
    uint256 public totalFee        = marketingFee + liquidityFee + devFee + reflectionFee;
